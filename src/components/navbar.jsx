...
export default function NavBar() {
    ...
    <nav className='flex items-center justify-between bg-black pl-10 pr-5 h-24'>
      <ul className='flex items-end gap-32 mr-5'>
        ...
        <li><Link className='hover:text-blue-950' href="/novidades">Novidades</Link></li>
        <li><Link className='hover:text-blue-950' href="/ofertas">Ofertas</Link></li>
        <li><Link className='hover:text-blue-950' href="/ordenar">Ordenar</Link></li>
      </ul>

      <div className='w-36 h-6 mt-2 mr-4'>
        <input type="text" placeholder='Buscar' 
        className='rounded-xl w-36 pl-3 text-black 
      ...
      <div>
        <Button href="/usuario" icon={ <img src="https://github.com/pedro2398.png" alt="img usuario" className="h-8 w-8 rounded-full"/> }></Button>
      </div>
    </nav>
    )
}